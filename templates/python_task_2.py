...
def find_ids_within_ten_percentage_threshold(df, reference_id)->pd.DataFrame():
    ...
    within_threshold_values = df[(df['distance'] >= lower_threshold) & (df['distance'] <= upper_threshold)]['id_start'].unique()
    sorted_within_threshold_values = sorted(within_threshold_values)
